...
#we are creating a flask group function that is stored in cli variable
#this function is used to create commands
cli = FlaskGroup(create_app=create_app)

#dictionaries that contain all the data of database
user_json = [
	{
		"name": "John Doe",
...
#recreate_db funtions deletes and re-creates the database
def recreate_db():
	db.drop_all()
	db.create_all()
	db.session.commit()
#seeder function re-enters the data into the newly created database by recreate_db
def seeder():
